...
{
    public class Susie : Character
    {
        public Susie(CharacterCreationContext characterCreationContext) : base(characterCreationContext) {}
    
        public override void LoadContent(ContentManager contentManager)
        {
            OrientedAnimatedSprite idleSprite = new OrientedAnimatedSprite(
                contentManager.Load<Texture2D>("Included/Susie/Spr_Susie_Walk_Up"),    
                contentManager.Load<Texture2D>("Included/Susie/Spr_Susie_Walk_Down"), 
                contentManager.Load<Texture2D>("Included/Susie/Spr_Susie_Walk_Left"),
                4
            );
