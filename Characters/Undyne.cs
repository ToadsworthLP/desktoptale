...
{
    public class Undyne : Character
    {
        public Undyne(CharacterCreationContext characterCreationContext) : base(characterCreationContext) {}
    
        public override void LoadContent(ContentManager contentManager)
        {
            OrientedAnimatedSprite idleSprite = new OrientedAnimatedSprite(
                contentManager.Load<Texture2D>("Included/Undyne/Spr_Undyne_Walk_Up"), 4,    
                contentManager.Load<Texture2D>("Included/Undyne/Spr_Undyne_Walk_Down"), 4,    
                contentManager.Load<Texture2D>("Included/Undyne/Spr_Undyne_Walk_Left"), 2
            );
