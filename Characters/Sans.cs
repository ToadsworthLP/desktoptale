...
namespace Desktoptale.Characters
{
    ...
    {
        public Sans(CharacterCreationContext characterCreationContext) : base(characterCreationContext) {}
    
        public override void LoadContent(ContentManager contentManager)
        {
            OrientedAnimatedSprite idleSprite = new OrientedAnimatedSprite(
                contentManager.Load<Texture2D>("Included/Sans/Spr_Sans_Walk_Up"),   
                contentManager.Load<Texture2D>("Included/Sans/Spr_Sans_Walk_Down"), 
                contentManager.Load<Texture2D>("Included/Sans/Spr_Sans_Walk_Left"),
                4
            );
